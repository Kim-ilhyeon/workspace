...
public class If {
	 ...
	 * 	순차적인 흐름을 바꾸고자 할 때 제어문 (조건문, 반복문, ...)을 사용하여 제어가능
	 ...
	 * 				// 조건식이 참인 경우 실행할 코드
	 * 			} else if (조건식2) {
	 * 				// 조건식1이 거짓이고, 조건식2가 참인 경우 실행할 코드
	 * 			} else {
	 * 				// 조건식 모두가 거짓인 경우 실행할 코드
	 * 			}
	 */
...
//		method3();
	...
	public static void method1() {
		...
		System.out.print("1 ~ 10 사이의 정수입력 :");
		int num = sc.nextInt();
	...
	public static void method2() {
		/* TODO:
		 * 문자를 입력받아 소문자인 경우 "{입력받은 값}은 소문자 입니다." 출력
		 * 대문자인 경우 "{입력받은 값}은 대문자 입니다." 출력
		...
		if ((ch >= 'a') && (ch <= 'z')) {	// 입력받은 값이 a ~ z 사이인 경우
			...
			// 입력받은 값이 a ~ z 사이가 아니고, A ~ Z 사이인경우
			System.out.printf("%c은 대문자입니다.\n", ch);			
		}else {
			// 입력받은 값이 a ~ z 사이가 아니고, A ~ Z 사이도 아닌경우
	...
	public static void method3() {
		 ...
		 * (단, -를 포함해서 입력받은 값의 길이가 14가 아닌경우 "잘못 입력되었습니다." 출력
		...
		if (numLeng == 14) { 
			char gender = num.charAt(7);	// 입력받은 값에서 인덱스 7번 위치의 문자를 추출(접근)
